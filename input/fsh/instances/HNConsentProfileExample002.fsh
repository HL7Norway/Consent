Instance: HNConsentProfileExample002
InstanceOf: HNWithdrawConsentProfile
Usage: #example
Title: "Deny access for all for a period of time"
Description: """
Example to deny access to everything for everyone for a period of time.
